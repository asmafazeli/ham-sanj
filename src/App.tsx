      ...
      <header className="brand-row">
        <div className="brand">
          ...
          <h2 className="brand-title">
            سنجش هوشمند همدلی و لحن در چت‌های پشتیبانی
          </h2>
          <p>ابزار کنترل کیفیت (QC) ما، تجربه مشتریان را ارتقا دهید.</p>
          <p>
            امتیاز همدلی (۰ تا ۹)، برچسب دقیق لحن و تحلیل الگوهای سوگیری شناختی را
            به‌صورت یکپارچه در قالب JSON دریافت کنید.
          </p>
        </div>
