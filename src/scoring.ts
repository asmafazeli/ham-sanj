...
کارشناس: همان‌طور که گفتم، واضحه که اشتباه از سمت شما بوده است. نیازی به تکرار نیست. صبر کنید تا مبلغ تعیین وضعیت شود.`,
  },
  {
    id: 'fundamental_attribution_error',
    label: 'خطای اسناد',
    text: `کاربر: چرا سفارشم انجام نشده؟ من کاری نکردم ولی صفر درصد مونده
کارشناس: تقصیر شماست؛ بی‌دقتی شما در ثبت قیمت باعث شد سفارش انجام نشود و مشکل از سمت شما می باشد!`,
  },
  {
    id: 'anchoring',
    label: 'لنگراندازی',
    text: `کاربر: آدرس را دوباره چک کردم، درسته. هنوز نرسیده.
کارشناس: حتماً آدرس اشتباه است و فقط همان مشکل قبلی را تکرار کرده اید.
آدرس از اول اشتباه بوده است.`,
  },
  {
    id: 'negativity_bias',
    label: 'منفی‌نگری',
    text: `کاربر: چند بار پیام دادم کسی جواب نداد
کارشناس: شما مکررا پیام ارسال کرده اید و هر بار نام شما در صف کاربران جدید قرار گرفته است!
علاوه بر آنکه ارسال مداوم پیام های شما منجر به کلافگی کارشناسان شده است! به دلیل ارسال پیام مکرر نیز دیر تر پاسخ داده شد. مکررا پیام ارسال نکنید.`,
  },
  {
    id: 'empathy_gap',
    label: 'شکاف همدلی',
    text: `کاربر: قیمت داره میره بالا و هنوز واریز تومنم نیومده استرس دارم پیگیری کنید لطفا.
کارشناس: عدم اعمال واریزی جدی و پر اهمیت نبوده است و واریز شما مطابق سیکل های پایا تسویه میشود باید صبر کنید.`,
  },
  {
    id: 'availability_heuristic',
    label: 'در دسترس‌بودن',
    text: `کاربر: من سفارشم هنوز انجام نشده استرس گرفتم قیمت داره همینجوری میره بالا. چک میکنید؟
کارشناس: تمامی سفارشات همینطور انجام میشوند و مورد مهمی وجود ندارد. مانند دیگر کاربران صبوری بفرمایید.`,
  },
  {
    id: 'defensive_reactance',
    label: 'واکنش دفاعی',
    text: `کاربر: چرا قیمت به حدسودم رسیده معامله ی منو نبستید؟؟؟؟ این چه وضعیه
من کلی ضرر کردم باید ضرر منو جبران کنین
کارشناس: مشکل از ما نیست و باتوجه به نوع سفارشات، معامله انجام میشود.
سیستم والکس مشکلی ندارد و تمامی موارد صحیح اعمال شده اند.`,
  },
  {
    id: 'framing_effect',
    label: 'اثر قاب‌بندی',
    text: `کاربر: فکر می‌کنم سیستم خطا داده و برداشت دو بار انجام شده
کارشناس: بله مقصد شما هستید و می بایست صبر میکردید تا تراکنش اول تعیین وضعیت شود و بعد دوباره امتحان کنید. این مورد را خودتان باید چک می‌کردید.`,
  },
  {
    id: 'illusion_of_transparency',
    label: 'توهم شفافیت',
    text: `کاربر: نمی‌فهمم مرحله بعدی چیه؛ چجوری باید واریز کنم لطفا توضیح بدین.
کارشناس: این مورد بسیار واضح می باشد مطابق روال معمول، به شیوه‌ی کارت به کارت واریز را انجام دهید.`,
  },
  {
    id: 'action_bias',
    label: 'اقدام فوری',
    // Exact user-provided sample (اقدام فوری)
    text: `کاربر: خیلی نگرانم؛ نمی‌دونم چی کار کنم.
کارشناس: وارد لینک ارسال شده شوید و فرم را تکمیل کرده و درخواست خود را ثبت کنید`,
  },
] as const
