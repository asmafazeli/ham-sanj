...
function agentLines(chat: string): string[] {
  ...
  const labeled = lines.filter((line) =>
    /^(اپراتور|پشتیبان|agent|support|ادمین)\s*[:：]/i.test(line),
  )
...
export const SAMPLE_CHATS = [
  {
    id: 'good',
    label: 'نمونه خوب',
    text: `کاربر: سه‌روزه سفارشم نرسیده و خیلی نگرانم، مهمان دارم.
اپراتور: کاملاً حق دارید نگران باشید؛ تأخیر در چنین شرایطی استرس‌زاست.
کاربر: اینه کد پیگیری: TRK-9921
اپراتور: ممنون که گفتید. الان همان لحظه وضعیت مرسوله را چک می‌کنم و تا ۳۰ دقیقه نتیجه قطعی را بهتون می‌گویم.`,
  },
  {
    id: 'weak',
    label: 'نمونه ضعیف',
    text: `کاربر: سه‌روزه سفارشم نرسیده و خیلی نگرانم، مهمان دارم.
اپراتور: کد پیگیری بفرستید.
کاربر: اینه: TRK-9921. واقعاً استرس دارم.
اپراتور: پیگیری می‌شود. فقط صبر کنید.`,
  },
  {
    id: 'harsh',
    label: 'نمونه تند',
    text: `کاربر: چرا کسی جوابمو نمی‌ده؟ عصبانی‌ام.
اپراتور: خودتون مشکل دارید که اینقدر پیام می‌دید. برو سایت وضعیت سفارش را ببین. مشکل از ما نیست.`,
  },
  {
    id: 'confirmation_bias',
    label: 'سوگیری تأیید',
